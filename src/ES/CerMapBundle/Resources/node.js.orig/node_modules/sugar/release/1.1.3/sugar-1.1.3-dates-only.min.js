...
return m.each(d,b)},compact:function(a){var b=[];D(this,function(c){if(m.isArray(c))b.push(c.compact());else if(a&&c)b.push(c);else if(!a&&E(c)&&c!==null&&(!m.isNumber(c)||!isNaN(c)))b.push(c)});return b}});function K(a,b,c){c=Math[c||"round"];var d=Math.pow(10,(b||0).abs());if(b<0)d=1/d;return c(a*d)/d}function ea(a,b,c,d){var f=[];a=parseInt(a);for(var g=d>0;g&&a<=b||!g&&a>=b;){f.push(a);c&&c.call(this,a);a+=d}return f}
v(u,i,j,{toNumber:function(){return parseFloat(this,10)},ceil:function(a){return K(this,a,"ceil")},floor:function(a){return K(this,a,"floor")},abs:function(){return Math.abs(this)},ordinalize:function(){var a;if(this>=11&&this<=13)a="th";else switch(this%10){case 1:a="st";break;case 2:a="nd";break;case 3:a="rd";break;default:a="th"}return this.toString()+a},pad:function(a,b,c){c=c||10;var d=this.toNumber()===0?"":this.toString(c).replace(/^-/,"");c=d;a=a-d.replace(/\.\d+$/,"").length;d=0;var f=String("0");
if(f!="0")f="";m.isNumber(a)||(a=1);m.isNumber(d)||(d=1);d=f.repeat(a)+c+f.repeat(d);if(b||this<0)d=(this<0?"-":"+")+d;return d}});
function fa(a,b){function c(){return K(this*b)}function d(){return L(arguments)[g](this)}function f(){return L(arguments)[g](-this)}var g="add"+a.capitalize()+"s";x(u.prototype,a,c);x(u.prototype,a+"s",c);x(u.prototype,a+"Before",f);x(u.prototype,a+"sBefore",f);x(u.prototype,a+"Ago",f);x(u.prototype,a+"sAgo",f);x(u.prototype,a+"After",d);x(u.prototype,a+"sAfter",d);x(u.prototype,a+"FromNow",d);x(u.prototype,a+"sFromNow",d)}
function M(){return"\t\n\u000b\u000c\r \u00a0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u2028\u2029\u3000\ufeff"}
...
to:["month","date","year"],i:i}],ia=[{c:"f{1,4}|ms|milliseconds",b:function(a){return a.getMilliseconds()}},{c:"ss?|seconds",b:function(a){return a.getSeconds()}},{c:"mm?|minutes",b:function(a){return a.getMinutes()}},{c:"hh?|hours|12hr",b:function(a){a=a.getHours(void 0);return a===0?12:a-(a/13).floor()*12}},{c:"HH?|24hr",b:function(a){return a.getHours()}},{c:"dd?|date|day",b:function(a){return a.getDate()}},{c:"dow|weekday",j:i,b:function(a,b,c){return b.weekdays[a.getDay()+(c-1)*7]}},{c:"MM?",
b:function(a){return a.getMonth()+1}},{c:"mon|month",j:i,b:function(a,b,c){return b.months[a.getMonth()+(c-1)*12]}},{c:"y{2,4}|year",b:function(a){return a.getFullYear()}},{c:"[Tt]{1,2}",b:function(a,b,c,d){a=a.getHours(void 0)<12?"am":"pm";if(d.length===1)a=a.first();if(d.first()==="T")a=a.toUpperCase();return a}},{c:"z{1,4}|tz|timezone",text:i,b:function(a,b,c,d){a=a.getUTCOffset();if(d=="z"||d=="zz")a=a.replace(/(\d{2})(\d{2})/,function(f,g){return g.toNumber().pad(d.length)});return a}},{c:"iso(tz|timezone)",
b:function(a){return a.getUTCOffset(i)}},{c:"ord",b:function(a){return a.getDate().ordinalize()}}],V=[{a:"year",method:"FullYear",d:function(a){return(365+(a?a.isLeapYear()?1:0:0.25))*24*60*60*1E3}},{a:"month",method:"Month",d:function(a,b){var c=30.4375,d;if(a){d=a.daysInMonth();if(b<=d.days())c=d}return c*24*60*60*1E3}},{a:"week",method:"Week",d:k(6048E5)},{a:"day",method:"Date",d:k(864E5)},{a:"hour",method:"Hours",d:k(36E5)},{a:"minute",method:"Minutes",d:k(6E4)},{a:"second",method:"Seconds",d:k(1E3)},
{a:"millisecond",method:"Milliseconds",d:k(1)}],W={},ja={en:"2;;January,February,March,April,May,June,July,August,September,October,November,December;Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday;millisecond:|s,second:|s,minute:|s,hour:|s,day:|s,week:|s,month:|s,year:|s;one,two,three,four,five,six,seven,eight,nine,ten;a,an,the;the,st|nd|rd|th,of;{num} {unit} {sign},{num} {unit=4-5} {sign} {day},{weekday?} {month} {date}{2} {year?} {time?},{date} {month} {year},{month} {year},{shift?} {weekday} {time?},{shift} week {weekday} {time?},{shift} {unit=5-7},{1} {edge} of {shift?} {unit=4-7?}{month?}{year?},{weekday} {3} {shift} week,{1} {date}{2} of {month},{1}{month?} {date?}{2} of {shift} {unit=6-7},{day} at {time?},{time} {day};{Month} {d}, {yyyy};,yesterday,today,tomorrow;,ago|before,,from now|after|from;,last,the|this,next;last day,end,,first day|beginning",
...
function ka(a){var b=s.addFormat,c=a.code;if(!a.m){b("("+a.months.compact().join("|")+")",["month"],c);b("("+a.weekdays.compact().join("|")+")",["weekday"],c);b("("+a.modifiers.filter(function(d){return d.name==="day"}).map("text").join("|")+")",["day"],c);D(a.formats,function(d){var f=[];d=d.replace(/\s+/g,"[-,. ]*");d=d.replace(/\{(.+?)\}/g,function(g,h){var e=h.match(/\?$/),l=h.match(/(\d)(?:-(\d))?/),q=h.match(/^\d+$/),n=h.replace(/[^a-z]+$/,""),p,y;if(n==="time"){f=f.concat(N);return e?P:O}if(q)p=
a.optionals[q[0]-1];else if(a[n])p=a[n];else if(a[n+"s"]){p=a[n+"s"];if(l){y=[];D(p,function(oa,pa){var ca=pa%(a.units?8:p.length);if(ca>=l[1]&&ca<=(l[2]||l[1]))y.push(oa)});p=y}p=p.compact().join("|")}if(q)return"(?:"+p+")?";else{f.push(n);return"("+p+")"+(e?"?":"")}});b(d,f,c)});a.m=i}}function X(a,b,c){if(b&&(!m.isString(a)||!a))a=Date.currentLocale;a&&!W[a]&&la(a,c);return W[a]}
function la(a,b){function c(g,h){g=g.split("+").map(function(e){return e.replace(/(.+):(.+)$/,function(l,q,n){return n.split("|").map(function(p){return q+p}).join("|")})}).join("|");return D(g.split("|"),h)}function d(g,h,e){var l=[];if(b[g]){D(b[g],function(q,n){c(q,function(p,y){l[y*e+n]=p.toLowerCase()})});if(h)l=l.concat(b[g].map(function(q){return q.slice(0,3).toLowerCase()}));return b[g]=l}}function f(g,h){var e="[0-9\uff10-\uff19]"+(g?"{"+g+","+h+"}":"+");if(b.digits)e+="|["+b.digits+"]+";
return e}b=b||ma(a);if(!b)throw Error("Invalid locale.");d("months",i,12);d("weekdays",i,7);d("units",j,8);d("numbers",j,10);b.code=a;b.date=f(1,2);b.year=f(4,4);b.num=function(){var g=[f()].concat(b.articles);b.digits||(g=g.concat(b.numbers));return g.compact().join("|")}();(function(){var g=[];b.g={};D(b.modifiers,function(h){c(h.text,function(e){b.g[e]=h;g.push({name:h.name,text:e,value:h.value})})});g.groupBy("name",function(h,e){e=e.map("text");if(h==="day")e=e.concat(b.weekdays);b[h]=e.join("|")});
...
else c.numbers=Q.split("");c.monthSuffix=d[1]}c.capitalizeUnit=a=="de";c.hasPlural=b(2);c.pastRelativeFormat=c.formats[0];c.futureRelativeFormat=c.formats[b(3)?1:0];return c}function qa(a){a||(a=Date.currentLocale);return a!="en"&&a!="en-US"}function na(a){m.merge(this,a)}
v(na,i,j,{getMonth:function(a){return m.isNumber(a)?a-1:H(this.months,r(a,"i"),0,j,i)%12},l:function(a){return H(this.weekdays,r(a,"i"),0,j,i)%7},k:function(a){var b;return m.isNumber(a)?a:a&&(b=this.numbers.indexOf(a))!==-1?(b+1)%10:1},o:function(a){var b=this;return a.replace(this.numbers[9],"").replace(/./g,function(c){return b.k(c)})},n:function(a){return English.units[this.units.indexOf(a)%8]},r:function(a,b,c){var d,f;d=c>0?this.futureRelativeFormat:this.pastRelativeFormat;if(this.code=="ru"){f=
...
function ta(a,b){var c=new s,d=j,f,g,h,e,l,q,n;if(m.isDate(a))c=a;else if(m.isNumber(a))c=new s(a);else if(m.isObject(a)){c=(new s).set(a,i);e=a}else if(m.isString(a)){ka(X(b,i));g=qa(b);a=a.trim().replace(/\.+$/,"").replace(/^now$/,"");D(S,function(p){var y=a.match(p.q);if(y){h=p;e=sa(y,h.to);f=X(h.p,i);if(h.i&&!m.isString(e.month)&&(m.isString(e.date)||g)){n=e.month;e.month=e.date;e.date=n}if(e.year&&e.s.length===2)e.year=K((new s).getFullYear()/100)*100-K(e.year/100)*100+e.year;if(e.month){e.month=
f.getMonth(e.month);if(e.shift&&!e.unit)e.unit="year"}if(e.weekday&&e.date)delete e.weekday;else if(e.weekday){e.weekday=f.l(e.weekday);if(e.shift&&!e.unit)e.unit="week"}if(e.day&&(n=f.g[e.day])){e.day=n.value;c.resetTime();d=i}else if(e.day&&(n=f.l(e.day))>-1){delete e.day;e.weekday=n}if(e.date&&!m.isNumber(e.date))e.date=f.o(e.date);if(e.meridian)if(e.meridian==="pm"&&e.hour<12)e.hour+=12;if(e.offset_hours||e.offset_minutes){e.utc=i;e.offset_minutes=e.offset_minutes||0;e.offset_minutes+=e.offset_hours*
60;if(e.offset_sign==="-")e.offset_minutes*=-1;e.minute-=e.offset_minutes}if(e.unit){d=i;q=f.k(e.num);l=f.n(e.unit);if(e.shift||e.edge){q*=(n=f.g[e.shift])?n.value:0;if(l==="month"&&E(e.date)){c.set({day:e.date},i);delete e.date}if(l==="year"&&E(e.month)){c.set({month:e.month,day:e.date},i);delete e.month;delete e.date}}if(e.sign&&(n=f.g[e.sign]))q*=n.value;if(E(e.weekday)){c.set({weekday:e.weekday},i);delete e.weekday}e[l]=(e[l]||0)+q}if(e.year_sign==="-")e.year*=-1;return j}});if(h)if(d)c.advance(e);
else e.utc?c.setUTC(e,i):c.set(e,i);else c=a?new s(a):new s;if(e&&e.edge){n=f.g[e.edge];D(U.slice(4),function(p){if(E(e[p.a])){l=p.a;return j}});if(l==="year")e.e="month";else if(l==="month"||l==="week")e.e="day";c[(n.value<0?"endOf":"beginningOf")+l.capitalize()]();n.value===-2&&c.resetTime()}}return{f:c,set:e}}
function Z(a,b,c,d){var f,g=X(d,i),h=r(/^[A-Z]/);if(a.isValid())if(Date[b])b=Date[b];else{if(m.isFunction(b)){f=ua(a);b=b.apply(a,f.concat(g))}}else return"Invalid Date";if(!b&&!c)b=g.outputFormat;else if(!b&&c){f=f||ua(a);if(f[1]===0){f[1]=1;f[0]=1}return g.r(f[0],f[1],f[2])}D(ia,function(e){b=b.replace(r("\\{("+e.c+")(\\d)?\\}",e.j?"i":""),function(l,q,n){l=e.b(a,g,n||1,q);n=q.length;var p=q.match(/^(.)\1+$/);if(e.j){if(n===3)l=l.slice(0,3);if(p||q.match(h))l=l.capitalize()}else if(p&&!e.text)l=
(m.isNumber(l)?l.pad(n):l.toString()).last(n);return l})});return b}function va(a,b,c){var d=ta(b),f=0,g=b=0,h;if(c>0){b=g=c;h=i}if(!d.f.isValid())return j;if(d.set&&d.set.e){D(V,function(l){if(l.a===d.set.e)f=l.d(d.f,a-d.f)-1});if(d.set.edge||d.set.shift)d.f["beginningOf"+d.set.e.capitalize()]();if(!h&&d.set.sign&&d.set.e!="millisecond"){b=50;g=-50}}c=a.getTime();h=d.f.getTime();var e=h+f;if(d.set&&d.set.e=="week"&&(new Date(e+1)).getHours()!=0)e-=s.DSTOffset;return c>=h-b&&c<=e+g}
function $(a,b,c,d,f){if(m.isNumber(b)&&f)b={milliseconds:b};else if(m.isNumber(b)){a.setTime(b);return a}if(b.date)b.day=b.date;if(!f&&B(b.day)&&E(b.weekday)){a["set"+(d?"UTC":"")+"Weekday"](b.weekday);b.day=a["get"+(d?"UTC":"")+"Date"](void 0);delete b.weekday}D(U,function(g){if(E(b[g.a])||E(b[g.a+"s"])){b.e=g.a;return j}else if(c&&g.a!=="week"&&g.a!=="year")a["set"+(d?"UTC":"")+g.method](g.a==="day"?1:0)});D(V,function(g){var h=g.a;g=g.method;var e=E(b[h])?b[h]:b[h+"s"];if(!B(e)){if(f){if(h===
"week"){e=(b.day||0)+e*7;g="Date"}e=e*f+a["get"+g](void 0)}a["set"+(d?"UTC":"")+g](e);h==="month"&&e%12!=a.getMonth()&&a.setDate(0)}});return a}function ua(a){var b;a=a.millisecondsFromNow();var c=a.abs(),d=c,f=0;D(U.slice(1),function(g,h){b=K(c/g.d(),1).floor();if(b>=1){d=b;f=h+1}});return[d,f,a]}function L(a){var b;b=m.isNumber(a[1])?Y(a)[0]:a[0];return ta(b,a[1]).f}
v(s,j,j,{create:function(){return L(arguments)},now:function(){return(new s).getTime()},setLocale:function(a,b){var c=X(a,j,b);if(c){Date.currentLocale=a;ka(c);return c}},getLocale:function(a){return X(a,i)},addFormat:function(a,b,c,d){S.push({i:d,p:c,q:r("^"+a+"$","i"),to:b})}});
...
0,1)).getTime()+1)/6048E5).ceil()},getUTCWeek:function(){return((this.getTime()-(new s).setUTC(this.getUTCFullYear(),0,1,0,0,0,0).getTime()+1)/6048E5).ceil()},getUTCOffset:function(a){var b=this.h?0:this.getTimezoneOffset(),c=a===i?":":"";if(!b&&a)return"Z";return K(-b/60).pad(2,i)+c+(b%60).pad(2)},toUTC:function(){if(this.h)return this;var a=this.clone().addMinutes(this.getTimezoneOffset());a.h=i;return a},isUTC:function(){return this.h||this.getTimezoneOffset()===0},advance:function(){var a=Y(arguments);
return $(this,a[0],j,j,1,i)},rewind:function(){var a=Y(arguments);return $(this,a[0],j,j,-1)},isValid:function(){return!isNaN(this.getTime())},isAfter:function(a,b){return this.getTime()>s.create(a).getTime()-(b||0)},isBefore:function(a,b){return this.getTime()<s.create(a).getTime()+(b||0)},isBetween:function(a,b,c){var d=this.getTime();a=s.create(a).getTime();var f=s.create(b).getTime();b=Math.min(a,f);a=Math.max(a,f);c=c||0;return b-c<d&&a+c>d},isLeapYear:function(){var a=this.getFullYear();return a%
4===0&&a%100!==0||a%400===0},daysInMonth:function(){return 32-(new s(this.getFullYear(),this.getMonth(),32)).getDate()},format:function(a,b){return Z(this,a,j,b)},relative:function(a,b){if(m.isString(a)){b=a;a=null}return Z(this,a,i,b)},is:function(a,b){var c;if(m.isString(a)){a=a.trim().toLowerCase();switch(i){case a==="future":return this.getTime()>(new s).getTime();case a==="past":return this.getTime()<(new s).getTime();case a==="weekday":return this.getDay()>0&&this.getDay()<6;case a==="weekend":return this.getDay()===
0||this.getDay()===6;case (c=English.weekdays.indexOf(a)%7)>-1:return this.getDay()===c;case (c=English.months.indexOf(a)%12)>-1:return this.getMonth()===c}}return va(this,a,b)},resetTime:function(){return this.set({hour:0,minute:0,second:0,millisecond:0})},clone:function(){return new s(this.getTime())},compare:function(){return this-L(arguments)}});v(s,i,j,{getWeekday:s.prototype.getDay,getUTCWeekday:s.prototype.getUTCDay});
...
D(V,function(a,b){var c=a.a,d=c.capitalize(),f=a.d();x(s.prototype,c+"sSince",function(g,h){return K((this.getTime()-s.create(g,h).getTime())/f)});x(s.prototype,c+"sUntil",function(g,h){return K((s.create(g,h).getTime()-this.getTime())/f)});x(s.prototype,c+"sAgo",s.prototype[c+"sUntil"]);x(s.prototype,c+"sFromNow",s.prototype[c+"sSince"]);x(s.prototype,"add"+d+"s",function(g){var h={};h[c]=g;return this.advance(h)});fa(c,f);b<3&&D(["Last","This","Next"],function(g){x(s.prototype,"is"+g+d,function(){return this.is(g+
" "+c)})});if(b<4){x(s.prototype,"beginningOf"+d,function(){var g={};switch(c){case "year":g.year=this.getFullYear();break;case "month":g.month=this.getMonth();break;case "day":g.day=this.getDate();break;case "week":g.weekday=0}return this.set(g,i)});x(s.prototype,"endOf"+d,function(){var g={hours:23,minutes:59,seconds:59,milliseconds:999};switch(c){case "year":g.month=11;g.day=31;break;case "month":g.day=this.daysInMonth();break;case "week":g.weekday=6}return this.set(g,i)})}});
(function(){T=V.concat();T.splice(2,1);U=V.concat().reverse();var a="\\d{1,2}|"+English.months.join("|");D(ha,function(b){s.addFormat(b.src.replace(/\{month\}/,a)+P,b.to.concat(N),"en",b.i)});s.addFormat(O,N)})();(function(){var a=English.weekdays.slice(0,7),b=English.months.slice(0,12);D(["today","yesterday","tomorrow","weekday","weekend","future","past"].concat(a).concat(b),function(c){x(s.prototype,"is"+c.capitalize(),function(){return this.is(c)})})})();
...
(function(){var a=new s(s.UTC(1999,11,31));if(!a.toISOString||a.toISOString()!=="1999-12-31T00:00:00.000Z")v(s,i,i,{toISOString:function(){return Z(this.toUTC(),s.ISO8601_DATETIME)}});if(!a.toJSON||a.toJSON()!=="1999-12-31T00:00:00.000Z")v(s,i,i,{toJSON:s.prototype.toISOString});v(s,i,j,{iso:s.prototype.toISOString})})();})();
