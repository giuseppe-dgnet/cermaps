...
(function() {
  ...
  function equal(a, b, stack) {
    ...
    if(a === b) {
      ...
      return object.keys(a).length === object.keys(b).length &&
       ...
       return instanceOf(b, primitive) && a.valueOf() === b.valueOf();
     }
  }
  ...
  extend(object, false, false, {
     ...
     * @extra %each% is available as an instance method on extended objects and when using Object.sugar().
     * @example
     *
     ...
     * @extra %isEmpty% is available as an instance method on extended objects and when using Object.sugar().
     * @example
     *
     *   Object.isEmpty({})          -> true
     ...
     * @extra %empty% is available as an instance method as "equals" (note the "s") on extended objects and when using Object.sugar().
     * @example
     *
     ...
     * @extra Returned values are in no particular order. %values% is available as an instance method on extended objects and when using Object.sugar().
     * @example
     *
     ...
     * @extra Default is a shallow clone, unless [deep] is true. %clone% is available as an instance method on extended objects and when using Object.sugar().
     * @example
     *
  ...
  extend(object, false, function() { return arguments.length < 2; }, {
     ...
     * @extra This method is provided for browsers that don't support it natively, and additionally is enhanced to accept the callback [fn]. Returned keys are in no particular order. %keys% is available as an instance method on extended objects and when using Object.sugar().
     * @example
     *
  ...
  extend(array, true, false, {
    ...
    'sortBy': function(map, desc) {
      ...
      arr.sort(function(a, b) {
        ...
        var numeric = object.isNumber(aProperty);
  ...
  function getAdjustedDateUnit(d) {
    ...
    arrayEach(DateUnitsReversed.from(1), function(u, i) {
      next = (round(ams / u.multiplier(), 1)).floor();
      if(next >= 1) {
        value = next;
        unit = i + 1;
      }
  ...
  extend(date, false, false, {
    ...
    'addFormat': function(format, to, locale, variant) {
