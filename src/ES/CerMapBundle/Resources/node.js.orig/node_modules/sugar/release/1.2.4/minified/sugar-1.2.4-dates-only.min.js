...
var O=["hour","minute","second","millisecond","meridian","utc","offset_sign","offset_hours","offset_minutes"],P="\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d",Q="\u5341\u767e\u5343\u4e07",ga=r("["+P+Q+"]","g"),ha=[],R,S,ia=[{src:"(\\d{4})",to:["year"]},{src:"([+-])?(\\d{4})[-.]?({month})[-.]?(\\d{1,2})?",to:["year_sign","year","month","date"]},{src:"(\\d{1,2})[-.\\/]({month})[-.\\/]?(\\d{2,4})?",to:["month","date","year"],h:i},{src:"\\/Date\\((\\d+(?:\\+\\d{4})?)\\)\\/",to:["timestamp"],
s:j}],ja=[{b:"f{1,4}|ms|milliseconds",format:function(a){return a.getMilliseconds()}},{b:"ss?|seconds",format:function(a){return a.getSeconds()}},{b:"mm?|minutes",format:function(a){return a.getMinutes()}},{b:"hh?|hours|12hr",format:function(a){a=a.getHours(void 0);return a===0?12:a-(a/13|0)*12}},{b:"HH?|24hr",format:function(a){return a.getHours()}},{b:"dd?|date|day",format:function(a){return a.getDate()}},{b:"dow|weekday",i:i,format:function(a,b,c){return b.weekdays[a.getDay()+(c-1)*7]}},{b:"MM?",
format:function(a){return a.getMonth()+1}},{b:"mon|month",i:i,format:function(a,b,c){return b.months[a.getMonth()+(c-1)*12]}},{b:"y{2,4}|year",format:function(a){return a.getFullYear()}},{b:"[Tt]{1,2}",format:function(a,b,c,d){a=a.getHours(void 0)<12?"am":"pm";if(d.length===1)a=a.first();if(d.first()==="T")a=a.toUpperCase();return a}},{b:"z{1,4}|tz|timezone",text:i,format:function(a,b,c,d){a=a.getUTCOffset();if(d=="z"||d=="zz")a=a.replace(/(\d{2})(\d{2})/,function(g,f){return f.toNumber().pad(d.length)});
return a}},{b:"iso(tz|timezone)",format:function(a){return a.getUTCOffset(i)}},{b:"ord",format:function(a){return a.getDate().ordinalize()}}],T=[{a:"year",method:"FullYear",c:function(a){return(365+(a?a.isLeapYear()?1:0:0.25))*24*60*60*1E3}},{a:"month",method:"Month",c:function(a,b){var c=30.4375,d;if(a){d=a.daysInMonth();if(b<=d.days())c=d}return c*24*60*60*1E3}},{a:"week",method:"Week",c:k(6048E5)},{a:"day",method:"Date",c:k(864E5)},{a:"hour",method:"Hours",c:k(36E5)},{a:"minute",method:"Minutes",
c:k(6E4)},{a:"second",method:"Seconds",c:k(1E3)},{a:"millisecond",method:"Milliseconds",c:k(1)}],U={},ka={en:"2;;January,February,March,April,May,June,July,August,September,October,November,December;Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday;millisecond:|s,second:|s,minute:|s,hour:|s,day:|s,week:|s,month:|s,year:|s;one,two,three,four,five,six,seven,eight,nine,ten;a,an,the;the,st|nd|rd|th,of;{num} {unit} {sign},{num} {unit=4-5} {sign} {day},{weekday?} {month} {date}{1} {year?} {time?},{date} {month} {year},{month} {year},{shift?} {weekday} {time?},{shift} week {weekday} {time?},{shift} {unit=5-7},{0} {edge} of {shift?} {unit=4-7?}{month?}{year?},{weekday} {2} {shift} week,{0} {date}{1} of {month},{0}{month?} {date?}{1} of {shift} {unit=6-7},{day} at {time?},{time} {day};{Month} {d}, {yyyy};,yesterday,today,tomorrow;,ago|before,,from now|after|from;,last,the|this,next;last day,end,,first day|beginning",
...
function la(a){var b=a.code;if(!a.m){V("("+a.months.compact().join("|")+")",["month"],b);V("("+a.weekdays.compact().join("|")+")",["weekday"],b);V("("+a.modifiers.filter(function(c){return c.name==="day"}).map("src").join("|")+")",["day"],b);E(a.formats,function(c){a.addFormat(c,b,j)});a.m=i}}function V(a,b,c,d,g){g=g||"push";ha[g]({h:d,p:c,q:r("^"+a+"$","i"),to:b})}function W(a,b,c){if(b&&(!l.isString(a)||!a))a=Date.currentLocale;a&&!U[a]&&ma(a,c);return U[a]}
function ma(a,b){function c(f,h){f=f.split("+").map(function(e){return e.replace(/(.+):(.+)$/,function(m,q,n){return n.split("|").map(function(p){return q+p}).join("|")})}).join("|");return E(f.split("|"),h)}function d(f,h,e){var m=[];if(b[f]){E(b[f],function(q,n){c(q,function(p,x){m[x*e+n]=p.toLowerCase()})});if(h)m=m.concat(b[f].map(function(q){return q.slice(0,3).toLowerCase()}));return b[f]=m}}function g(f,h){var e="[0-9\uff10-\uff19]"+(f?"{"+f+","+h+"}":"+");if(b.digits)e+="|["+b.digits+"]+";
return e}b=b||na(a);if(!b)throw Error("Invalid locale.");d("months",i,12);d("weekdays",i,7);d("units",j,8);d("numbers",j,10);b.code=a;b.date=g(1,2);b.year=g(4,4);b.num=function(){var f=[g()].concat(b.articles);b.digits||(f=f.concat(b.numbers));return f.compact().join("|")}();(function(){var f=[];b.f={};E(b.modifiers,function(h){c(h.src,function(e){b.f[e]=h;f.push({name:h.name,src:e,value:h.value})})});f.groupBy("name",function(h,e){e=e.map("src");if(h==="day")e=e.concat(b.weekdays);b[h]=e.join("|")});
b.modifiers=f})();if(b.monthSuffix){b.month=g(1,2);b.months=da(1,12,null,1).map(function(f){return f+b.monthSuffix})}U[a]=new oa(b)}
function na(a){function b(g){return!!(d[0]&Math.pow(2,g-1))}if(a.slice(0,3)=="en-")a="en";if(!ka[a])return null;var c={modifiers:[]},d=ka[a].split(";");E(["months","weekdays","units","numbers","articles","optionals","formats"],function(g,f){c[g]=d[f+2]?d[f+2].split(","):[]});c.outputFormat=d[9];E(["day","sign","shift","edge"],function(g,f){d[f+10]&&E(d[f+10].split(","),function(h,e){h&&c.modifiers.push({name:g,src:h,value:e-2})})});if(b(1)){c.digits=P+Q;if(c.numbers.length>0)c.digits+=c.numbers.join("");
else c.numbers=P.split("");c.monthSuffix=d[1]}c.capitalizeUnit=a=="de";c.hasPlural=b(2);c.pastRelativeFormat=c.formats[0];c.futureRelativeFormat=c.formats[b(3)?1:0];c.durationFormat=c.formats[0].replace(/\s*\{sign\}\s*/,"");return c}function pa(a){a||(a=Date.currentLocale);return a!="en"&&a!="en-US"}function oa(a){l.merge(this,a)}
w(oa,i,j,{getMonth:function(a){return l.isNumber(a)?a-1:I(this.months,r(a,"i"),0,j,i)%12},l:function(a){return I(this.weekdays,r(a,"i"),0,j,i)%7},k:function(a){var b;return l.isNumber(a)?a:a&&(b=this.numbers.indexOf(a))!==-1?(b+1)%10:1},o:function(a){var b=this;return a.replace(this.numbers[9],"").replace(/./g,function(c){return b.k(c)})},n:function(a){return v.units[this.units.indexOf(a)%8]},r:function(a){return this.j(a,a[2]>0?"futureRelativeFormat":"pastRelativeFormat")},duration:function(a){return this.j(X(a),
...
a=a.replace(/\{(.+?)\}/g,function(f,h){var e=h.match(/\?$/),m=h.match(/(\d)(?:-(\d))?/),q=h.match(/^\d+$/),n=h.replace(/[^a-z]+$/,""),p,x;if(n==="time"){d=d.concat(O);return e?"\\s*(?:(?:t|at |\\s+)(\\d{1,2}):?(\\d{2})?:?(\\d{2})?(?:\\.(\\d{1,6}))?(am|pm)?(?:(Z)|(?:([+-])(\\d{2})(?::?(\\d{2}))?)?)?)?":"(\\d{1,2}):?(\\d{2})?:?(\\d{2})?(?:\\.(\\d{1,6}))?(am|pm)?(?:(Z)|(?:([+-])(\\d{2})(?::?(\\d{2}))?)?)?"}if(q)p=g.optionals[q[0]];else if(g[n])p=g[n];else if(g[n+"s"]){p=g[n+"s"];if(m){x=[];p.forEach(function(ta,
ua){var ea=ua%(g.units?8:p.length);if(ea>=m[1]&&ea<=(m[2]||m[1]))x.push(ta)});p=x}p=p.compact().join("|")}if(q)return"(?:"+p+")?";else{d.push(n);return"("+p+")"+(e?"?":"")}});V(a,d,b)}});function Y(a){var b;if(typeof a[0]=="object")return a;else if(a.length==1&&l.isNumber(a[0]))return[a[0]];b={};E(R,function(c,d){b[c.a]=a[d]});return[b]}
function qa(a,b){a=a.replace(/[\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19\uff10]/g,function(c){return String.fromCharCode(c.charCodeAt(0)-65248)});if(b!="date"&&b!="month"&&b!="year")return a;return a.replace(ga,function(c){return P.indexOf(c)+1||""})}function ra(a,b){var c={},d,g;E(b,function(f,h){d=a[h+1];if(!(C(d)||d==="")){d=qa(d,f);if(f==="year")c.t=d;if(f==="millisecond")d*=Math.pow(10,3-d.length);g=parseFloat(d);c[f]=!isNaN(g)?g:d.toLowerCase()}});return c}
function sa(a,b){var c=new s,d=j,g,f,h,e,m,q,n;if(l.isDate(a))c=a;else if(l.isNumber(a))c=new s(a);else if(l.isObject(a)){c=(new s).set(a,i);e=a}else if(l.isString(a)){la(W(b,i));f=pa(b);a=a.trim().replace(/\.+$/,"").replace(/^now$/,"");E(ha,function(p){var x=a.match(p.q);if(x){h=p;e=ra(x,h.to);g=W(h.p,i);if(e.timestamp){c.setTime(0);e={milliseconds:e.timestamp};return j}if(h.h&&!l.isString(e.month)&&(l.isString(e.date)||f)){n=e.month;e.month=e.date;e.date=n}if(e.year&&e.t.length===2)e.year=L((new s).getFullYear()/
...
"-")e.year*=-1;return j}});if(h)if(d)c.advance(e);else if(e.utc){c.resetTime();c.setUTC(e,i)}else c.set(e,i);else c=a?new s(a):new s;if(e&&e.edge){n=g.f[e.edge];E(S.slice(4),function(p){if(F(e[p.a])){m=p.a;return j}});if(m==="year")e.d="month";else if(m==="month"||m==="week")e.d="day";c[(n.value<0?"endOf":"beginningOf")+m.capitalize()]();n.value===-2&&c.resetTime()}}return{e:c,set:e}}
function Z(a,b,c,d){var g,f=W(d,i),h=r(/^[A-Z]/);if(a.isValid())if(Date[b])b=Date[b];else{if(l.isFunction(b)){g=X(a.millisecondsFromNow());b=b.apply(a,g.concat(f))}}else return"Invalid Date";if(!b&&!c)b=f.outputFormat;else if(!b&&c){g=g||X(a.millisecondsFromNow());if(g[1]===0){g[1]=1;g[0]=1}return f.r(g)}E(ja,function(e){b=b.replace(r("\\{("+e.b+")(\\d)?\\}",e.i?"i":""),function(m,q,n){m=e.format(a,f,n||1,q);n=q.length;var p=q.match(/^(.)\1+$/);if(e.i){if(n===3)m=m.slice(0,3);if(p||q.match(h))m=m.capitalize()}else if(p&&
!e.text)m=(l.isNumber(m)?m.pad(n):m.toString()).last(n);return m})});return b}function va(a,b,c){var d=sa(b),g=0,f=b=0,h;if(c>0){b=f=c;h=i}if(!d.e.isValid())return j;if(d.set&&d.set.d){E(T,function(m){if(m.a===d.set.d)g=m.c(d.e,a-d.e)-1});if(d.set.edge||d.set.shift)d.e["beginningOf"+d.set.d.capitalize()]();if(!h&&d.set.sign&&d.set.d!="millisecond"){b=50;f=-50}}c=a.getTime();h=d.e.getTime();var e=h+g;if(d.set&&d.set.d=="week"&&(new Date(e+1)).getHours()!=0)e-=s.DSTOffset;return c>=h-b&&c<=e+f}
function $(a,b,c,d,g){if(l.isNumber(b)&&g)b={milliseconds:b};else if(l.isNumber(b)){a.setTime(b);return a}if(b.date)b.day=b.date;if(!g&&C(b.day)&&F(b.weekday)){a["set"+(d?"UTC":"")+"Weekday"](b.weekday);b.day=a["get"+(d?"UTC":"")+"Date"](void 0);delete b.weekday}E(S,function(f){if(F(b[f.a])||F(b[f.a+"s"])){b.d=f.a;return j}else if(c&&f.a!=="week"&&f.a!=="year")a["set"+(d?"UTC":"")+f.method](f.a==="day"?1:0)});E(T,function(f){var h=f.a;f=f.method;var e=F(b[h])?b[h]:b[h+"s"];if(!C(e)){if(g){if(h===
"week"){e=(b.day||0)+e*7;f="Date"}e=e*g+a["get"+f](void 0)}a["set"+(d?"UTC":"")+f](e);if(h==="month"){h=e;if(h<0)h+=12;h%12!=a.getMonth()&&a.setDate(0)}}});return a}function wa(a){a.addDays(4-(a.getDay()||7)).resetTime();return 1+(a.daysSince(a.clone().beginningOfYear())/7|0)}function X(a){var b,c=Math.abs(a),d=c,g=0;E(S.slice(1),function(f,h){b=L(c/f.c(),1)|0;if(b>=1){d=b;g=h+1}});return[d,g,a]}function M(a){var b;b=l.isNumber(a[1])?Y(a)[0]:a[0];return sa(b,a[1]).e}
function xa(a){var b=new s(s.UTC(1999,11,31)),c={};if(!b[a]||b[a]()!=="1999-12-31T00:00:00.000Z"){c[a]=function(){return Z(this.toUTC(),s.ISO8601_DATETIME)};w(s,i,i,c)}}w(s,j,j,{create:function(){return M(arguments)},now:function(){return(new s).getTime()},setLocale:function(a,b){var c=W(a,j,b);if(c){Date.currentLocale=a;la(c);return c}},getLocale:function(a){return W(a,i)},addFormat:function(a,b,c,d){V(a,b,c,d,"unshift")}});
...
(function(){R=T.concat();R.splice(2,1);S=T.concat().reverse();var a="\\d{1,2}|"+v.months.join("|");E(ia,function(b){s.addFormat(b.src.replace(/\{month\}/,a)+(b.s===j?"":"\\s*(?:(?:t|at |\\s+)(\\d{1,2}):?(\\d{2})?:?(\\d{2})?(?:\\.(\\d{1,6}))?(am|pm)?(?:(Z)|(?:([+-])(\\d{2})(?::?(\\d{2}))?)?)?)?"),b.to.concat(O),"en",b.h)});V("(\\d{1,2}):?(\\d{2})?:?(\\d{2})?(?:\\.(\\d{1,6}))?(am|pm)?(?:(Z)|(?:([+-])(\\d{2})(?::?(\\d{2}))?)?)?",O)})();
(function(){var a=v.weekdays.slice(0,7),b=v.months.slice(0,12);E(["today","yesterday","tomorrow","weekday","weekend","future","past"].concat(a).concat(b),function(c){z(s.prototype,"is"+c.capitalize(),function(){return this.is(c)})})})();xa("toISOString");xa("toJSON");
