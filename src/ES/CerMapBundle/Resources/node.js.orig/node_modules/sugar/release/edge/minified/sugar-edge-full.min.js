...
G(r,m,m,{keys:function(a){var b=[];if(!ka(a)&&!F(a)&&!C(a))throw new TypeError("Object required");I(a,function(c){b.push(c)});return b}});function ua(a,b,c,d){var e=a.length,g=d==-1,f=g?e-1:0;c=isNaN(c)?f:parseInt(c>>0);if(c<0)c=e+c;if(!g&&c<0||g&&c>=e)c=f;for(;g&&c>=0||!g&&c<e;){if(a[c]===b)return c;c+=d}return-1}
function va(a,b,c,d){var e=a.length,g=0,f=K(c);wa(b);if(e==0&&!f)throw new TypeError("Reduce called on empty array with no initial value");else if(f)c=c;else{c=a[d?e-1:g];g++}for(;g<e;){f=d?e-g-1:g;if(f in a)c=b(c,a[f],f,a);g++}return c}function wa(a){if(!a||!a.call)throw new TypeError("Callback is not callable");}function xa(a){if(a.length===0)throw new TypeError("First argument must be defined");}G(s,m,m,{isArray:function(a){return fa(a,"Array")}});
G(s,j,m,{every:function(a,b){var c=this.length,d=0;for(xa(arguments);d<c;){if(d in this&&!a.call(b,this[d],d,this))return m;d++}return j},some:function(a,b){var c=this.length,d=0;for(xa(arguments);d<c;){if(d in this&&a.call(b,this[d],d,this))return j;d++}return m},map:function(a,b){var c=this.length,d=0,e=Array(c);for(xa(arguments);d<c;){if(d in this)e[d]=a.call(b,this[d],d,this);d++}return e},filter:function(a,b){var c=this.length,d=0,e=[];for(xa(arguments);d<c;){d in this&&a.call(b,this[d],d,this)&&
e.push(this[d]);d++}return e},indexOf:function(a,b){if(E(this))return this.indexOf(a,b);return ua(this,a,b,1)},lastIndexOf:function(a,b){if(E(this))return this.lastIndexOf(a,b);return ua(this,a,b,-1)},forEach:function(a,b){var c=this.length,d=0;for(wa(a);d<c;){d in this&&a.call(b,this[d],d,this);d++}},reduce:function(a,b){return va(this,a,b)},reduceRight:function(a,b){return va(this,a,b,j)}});
(function(){var a=qa().match(/^\s+$/);try{v.prototype.trim.call([1])}catch(b){a=m}G(v,j,!a,{trim:function(){return this.toString().trimLeft().trimRight()},trimLeft:function(){return this.replace(t("^["+qa()+"]+"),"")},trimRight:function(){return this.replace(t("["+qa()+"]+$"),"")}})})();
(function(){var a=m;if(Function.prototype.va){a=function(){};var b=a.va();a=new b instanceof b&&!(new a instanceof b)}G(Function,j,!a,{bind:function(c){var d=this,e=H(arguments).slice(1),g,f;if(!C(this))throw new TypeError("Function.prototype.bind called on a non-function");f=function(){return d.apply(d.prototype&&this instanceof d?this:c,e.concat(H(arguments)))};g=function(){};g.prototype=this.prototype;f.prototype=new g;return f}})})();
(function(){var a=new u(u.UTC(1999,11,31));a=a.toISOString&&a.toISOString()==="1999-12-31T00:00:00.000Z";J(u,j,!a,"toISOString,toJSON",function(b,c){b[c]=function(){return Q(this.getUTCFullYear(),4)+"-"+Q(this.getUTCMonth()+1,2)+"-"+Q(this.getUTCDate(),2)+"T"+Q(this.getUTCHours(),2)+":"+Q(this.getUTCMinutes(),2)+":"+Q(this.getUTCSeconds(),2)+"."+Q(this.getUTCMilliseconds(),3)+"Z"}})})();
...
ab.prototype={getMonth:function(a){return D(a)?a-1:this.months.indexOf(a)%12},ta:function(a){return this.weekdays.indexOf(a)%7},sa:function(a){var b;return D(a)?a:a&&(b=this.numbers.indexOf(a))!==-1?(b+1)%10:1},ya:function(a){var b=this;return a.replace(t(this.num,"g"),function(c){return b.sa(c)||""})},wa:function(a){return W.units[this.units.indexOf(a)%8]},Ea:function(a){return this.ra(a,a[2]>0?"futureRelativeFormat":"pastRelativeFormat")},duration:function(a){return this.ra(bb(a),"durationFormat")},
za:function(a){a=a||this.code;return a==="en"||a==="en-US"?j:this.variant},Ca:function(a){return a&&(a==="pm"||a===this.pm)},ra:function(a,b){var c=a[0],d=a[1],e=a[2],g,f,i;if(this.code=="ru"){i=c.toString().slice(-1);switch(j){case i==1:i=1;break;case i>=2&&i<=4:i=2;break;default:i=3}}else i=this.hasPlural&&c>1?1:0;f=this.units[i*8+d]||this.units[d];if(this.capitalizeUnit)f=cb(f);g=this.modifiers.filter(function(h){return h.name=="sign"&&h.value==(e>0?1:-1)})[0];return this[b].replace(/\{(.*?)\}/g,
function(h,l){switch(l){case "num":return c;case "unit":return f;case "sign":return g.src}})},xa:function(){return this.qa?[this.qa].concat(this.ha):this.ha},addFormat:function(a,b,c,d,e){var g=c||[],f=this;a=a.replace(/\s+/g,"[-,. ]*");a=a.replace(/\{([^,]+?)\}/g,function(i,h){var l=h.match(/\?$/),n=h.match(/(\d)(?:-(\d))?/),p=h.match(/^\d+$/),q=h.replace(/[^a-z]+$/,""),y,L;if(p)y=f.optionals[p[0]];else if(f[q])y=f[q];else if(f[q+"s"]){y=f[q+"s"];if(n){L=[];y.forEach(function(B,Ca){var ha=Ca%(f.units?
8:y.length);if(ha>=n[1]&&ha<=(n[2]||n[1]))L.push(B)});y=L}y=db(y)}if(p)return"(?:"+y+")?";else{c||g.push(q);return"("+y+")"+(l?"?":"")}});if(b){b=eb(Ra,this,e);e=a.match(/\\d\{\d,\d\}\)+\??$/);fb(this,"(?:"+b+")[,\\s\\u3000]+?"+a,Qa.concat(g),d);fb(this,a+"(?:[,\\s]*(?:t|at |[\\s\\u3000]"+(e?"+":"*")+")"+b+")?",g.concat(Qa),d)}else fb(this,a,g,d)}};function gb(a,b,c){var d;if(!a||!E(a))return Pa;d=Za[a]||Za[a.slice(0,2)];if(!d||c)d=hb(a,c,b);return d}
function hb(a,b,c){function d(i,h){i=i.split("+").map(function(l){return l.replace(/(.+):(.+)$/,function(n,p,q){return q.split("|").map(function(y){return p+y}).join("|")})}).join("|");return i.split("|").forEach(h)}function e(i,h,l){var n=[];if(f[i]){f[i].forEach(function(p,q){d(p,function(y,L){n[L*l+q]=y.toLowerCase()})});if(h)n=n.concat(f[i].map(function(p){return p.slice(0,3).toLowerCase()}));return f[i]=n}}function g(i,h){var l="\\d{"+i+","+h+"}";if(f.digits)l+="|["+f.digits+"]+";return l}var f;
b=b||ib(a);if(!b)return c?m:Pa;f=new ab(b);e("months",j,12);e("weekdays",j,7);e("units",m,8);e("numbers",m,10);f.code=a;f.date=g(1,2);f.year=g(4,4);f.num=function(){var i=["\\d+"].concat(f.articles);if(f.numbers)i=i.concat(f.numbers);return db(i)}();(function(){var i=[];f.ia={};f.modifiers.forEach(function(h){var l=h.name;d(h.src,function(n){var p=f[l];f.ia[n]=h;i.push({name:l,src:n,value:h.value});f[l]=p?p+"|"+n:n})});f.day+="|"+db(f.weekdays);f.modifiers=i})();if(f.monthSuffix){f.month=g(1,2);f.months=
N(1,12).map(function(i){return i+f.monthSuffix})}f.full_month=g(1,2)+"|"+db(f.months);f.timeSuffixes.length>0&&f.addFormat(eb(Ra,f),m,Qa);f.addFormat("{day}",j);f.addFormat("{month}"+f.monthSuffix);f.addFormat("{year}"+f.yearSuffix);f.timeFormats.forEach(function(i){f.addFormat(i,j)});f.formats.forEach(function(i){f.addFormat(i)});return Za[a]=f}
function ib(a){function b(h){return!!(d[0]&x.pow(2,h-1))}var c={modifiers:[]},d,e,g,f,i;d=$a[a]||$a[a.slice(0,2)];if(!d)return k;d=d.split(";");c.monthSuffix=d[1];c.yearSuffix=d[2];["months","weekdays","units","numbers","articles","optionals","12hr","timeSuffixes","formats","timeFormats"].forEach(function(h,l){c[h]=d[l+3]?d[l+3].split(","):[]});e=d[13];g=d[14];f=e.replace(/[,\s]*\{Weekday\}[,\s]*/,"");i=g.replace(/:?\{ss\}[^{]?/,"");c.timeFormat=g;c.shortFormat=f;c.longFormat=f+" "+i;c.fullFormat=
e+" "+g;c.pm=c["12hr"][1];["day","sign","shift","edge"].forEach(function(h,l){d[l+15]&&d[l+15].split(",").forEach(function(n,p){n&&c.modifiers.push({name:h,src:n,value:p-2})})});if(b(1))c.digits=c.numbers.join("").replace(/\|/,"");c.capitalizeUnit=a=="de";c.hasPlural=b(2);c.pastRelativeFormat=c.formats[0];c.futureRelativeFormat=c.formats[b(3)?1:0];c.durationFormat=c.formats[0].replace(/\s*\{sign\}\s*/,"");c.variant=b(4);return c}
...
function kb(a,b){var c={};match=a.match(/^(\d+)?\s?(\w+?)s?$/i);if(M(b))b=parseInt(match[1])||1;c[match[2].toLowerCase()]=b;return c}function lb(a,b){var c={},d,e;b.forEach(function(g,f){d=a[f+1];if(!(M(d)||d==="")){if(g==="year")c.Ga=d;e=parseFloat(d.replace(/,/,"."));c[g]=!isNaN(e)?e:d.toLowerCase()}});return c}function mb(a){a=a.trim().replace(/^(just )?now|\.+$/i,"");return nb(a)}
function nb(a){return a.replace(Ta,function(b,c,d){var e=0,g=1,f,i;if(c)return b;d.split("").reverse().forEach(function(h){h=Sa[h];var l=h>9;if(l){if(f)e+=g;g*=h/(i||1);i=h}else{if(f===m)g*=10;e+=g*h}f=l});if(f)e+=g;return e})}
function ob(a,b,c){var d=new u,e=m,g,f,i,h,l,n,p,q,y;if(ea(a))d=a;else if(D(a))d=new u(a);else if(la(a)){d=(new u).set(a,j);h=a}else if(E(a)){g=gb(b,j);a=mb(a);g&&I(g.xa(),function(L,B){var Ca=a.match(B.Da);if(Ca){i=B;f=i.Ba;h=lb(Ca,i.to,f);f.qa=i;if(h.timestamp){h=h.timestamp;return m}if(i.Fa&&!E(h.month)&&(E(h.date)||g.za(b))){q=h.month;h.month=h.date;h.date=q}if(h.year&&h.Ga.length===2)h.year=O((new u).getFullYear()/100)*100-O(h.year/100)*100+h.year;if(h.month){h.month=f.getMonth(h.month);if(h.shift&&
!h.unit)h.unit=f.units[7]}if(h.weekday&&h.date)delete h.weekday;else if(h.weekday){h.weekday=f.ta(h.weekday);if(h.shift&&!h.unit)h.unit=f.units[5]}if(h.day&&(q=f.ia[h.day])){h.day=q.value;d.reset();e=j}else if(h.day&&(n=f.ta(h.day))>-1){delete h.day;if(h.num&&h.month){y=function(){pb(d,{weekday:n+7*(h.num-1)},m,m,m,1)};h.day=1}else h.weekday=n}if(h.date&&!D(h.date))h.date=f.ya(h.date);if(f.Ca(h["12hr"])&&h.hour<12)h.hour+=12;if("offset_hours"in h||"offset_minutes"in h){h.utc=j;h.offset_minutes=h.offset_minutes||
0;h.offset_minutes+=h.offset_hours*60;if(h.offset_sign==="-")h.offset_minutes*=-1;h.minute-=h.offset_minutes}if(h.unit){e=j;p=f.sa(h.num);l=f.wa(h.unit);if(h.shift||h.edge){p*=(q=f.ia[h.shift])?q.value:0;if(l==="month"&&K(h.date)){d.set({day:h.date},j);delete h.date}if(l==="year"&&K(h.month)){d.set({month:h.month,day:h.date},j);delete h.month;delete h.date}}if(h.sign&&(q=f.ia[h.sign]))p*=q.value;if(K(h.weekday)){d.set({weekday:h.weekday},j);delete h.weekday}h[l]=(h[l]||0)+p}if(h.year_sign==="-")h.year*=
-1;Va.slice(1,4).forEach(function(ha,Tb){var ub=h[ha.$],vb=ub%1;if(vb){h[Va[Tb].$]=O(vb*(ha.$==="second"?1E3:60));h[ha.$]=P(ub)}});return m}});if(i)if(e)d.advance(h);else{h.utc&&d.reset();pb(d,h,j,h.utc,m,c)}else d=a?new u(a):new u;if(h&&h.edge){q=f.ia[h.edge];I(Va.slice(4),function(L,B){if(K(h[B.$])){l=B.$;return m}});if(l==="year")h.fa="month";else if(l==="month"||l==="week")h.fa="day";d[(q.value<0?"endOf":"beginningOf")+cb(l)]();q.value===-2&&d.reset()}y&&y()}return{ea:d,set:h}}
function qb(a){a.addDays(4-(a.getDay()||7)).reset();return 1+P(a.daysSince(a.clone().beginningOfYear())/7)}function bb(a){var b,c=x.abs(a),d=c,e=0;Va.slice(1).forEach(function(g,f){b=P(O(c/g.da()*10)/10);if(b>=1){d=b;e=f+1}});return[d,e,a]}
function rb(a,b,c,d){var e,g=gb(d),f=t(/^[A-Z]/);if(a.isValid())if(Date[b])b=Date[b];else{if(C(b)){e=bb(a.millisecondsFromNow());b=b.apply(a,e.concat(g))}}else return"Invalid Date";if(!b&&c){e=e||bb(a.millisecondsFromNow());if(e[1]===0){e[1]=1;e[0]=1}return g.Ea(e)}b=b||"long";b=g[b+"Format"]||b;b=b.replace(/\{time\}/g,g.timeFormat);Xa.forEach(function(i){b=b.replace(t("\\{("+i.ba+")(\\d)?\\}",i.na?"i":""),function(h,l,n){h=i.format(a,g,n||1,l);n=l.length;var p=l.match(/^(.)\1+$/);if(i.na){if(n===
3)h=h.slice(0,3);if(p||l.match(f))h=cb(h)}else if(p&&!i.text)h=(D(h)?Q(h,n):h.toString()).slice(-n);return h})});return b}
function sb(a,b,c){var d=ob(b),e=0,g=b=0,f;if(c>0){b=g=c;f=j}if(!d.ea.isValid())return m;if(d.set&&d.set.fa){Ya.forEach(function(h){if(h.$===d.set.fa)e=h.da(d.ea,a-d.ea)-1});c=cb(d.set.fa);if(d.set.edge||d.set.shift)d.ea["beginningOf"+c]();if(d.set.fa==="month")i=d.ea.clone()["endOf"+c]().getTime();if(!f&&d.set.sign&&d.set.fa!="millisecond"){b=50;g=-50}}f=a.getTime();c=d.ea.getTime();var i=i||c+e;return f>=c-b&&f<=i+g}
function pb(a,b,c,d,e,g){function f(n){return K(b[n])?b[n]:b[n+"s"]}var i;if(D(b)&&e)b={milliseconds:b};else if(D(b)){a.setTime(b);return a}if(b.date)b.day=b.date;I(Va,function(n,p){var q=p.$==="day";if(K(f(p.$))||q&&K(f("weekday"))){b.fa=p.$;return m}else if(c&&p.$!=="week"&&(!q||!K(f("week"))))X(a,"set",d,p.method,q?1:0)});Ya.forEach(function(n,p){var q=n.$,y=n.method,L=Ya[p-1],B;B=f(q);if(!M(B)){g&&n.pa&&!K(f(L.$))&&X(new u,"get",d,n.method)>=B===(g===1)&&a[L.ka](g);if(e){if(q==="week"){B=(b.day||
0)+B*7;y="Date"}B=B*e+X(a,"get",m,y)}else q==="month"&&K(f("day"))&&a.setDate(15);X(a,"set",d,y,B);if(e&&q==="month"){q=B;if(q<0)q+=12;q%12!=a.getMonth()&&a.setDate(0)}}});if(!e&&!K(f("day"))&&K(f("weekday"))){i=f("weekday");var h,l;if(K(g)){h=X(a,"get",d,"Day")-i%7>=0;l=g===1;if(h===l)i+=g*7}X(a,"set",d,"Weekday",i)}return a}function X(a,b,c,d,e){return a[b+(c?"UTC":"")+d](e)}
function eb(a,b,c){var d={h:0,m:1,s:2},e;b=b||W;return a.replace(/{([a-z])}/g,function(g,f){var i=[],h=f==="h",l=h&&!c;if(f==="t")return b["12hr"].join("|");else{h&&i.push(":");if(e=b.timeSuffixes[d[f]])i.push(e+"\\s*");return i.length===0?"":"(?:"+i.join("|")+")"+(l?"":"?")}})}function tb(a,b){var c;c=D(a[1])?jb(a)[0]:a[0];return ob(c,a[1],b).ea}
function wb(a,b){function c(){return O(this*b)}function d(){return tb(arguments)[a.ka](this)}function e(){return tb(arguments)[a.ka](-this)}var g=a.$,f={};f[g]=c;f[g+"s"]=c;f[g+"Before"]=e;f[g+"sBefore"]=e;f[g+"Ago"]=e;f[g+"sAgo"]=e;f[g+"After"]=d;f[g+"sAfter"]=d;f[g+"FromNow"]=d;f[g+"sFromNow"]=d;w.extend(f)}
u.extend({create:function(){return tb(arguments)},past:function(){return tb(arguments,-1)},future:function(){return tb(arguments,1)},now:function(){return(new u).getTime()},setLocale:function(a,b){var c=gb(a,j,b);if(c){Pa=c;if(a&&a!=c.code)c.code=a}return c},getLocale:function(a){return gb(a)},addFormat:function(a,b,c){fb(gb(c),a,b)}},m,m);
u.extend({set:function(){var a=jb(arguments);return pb(this,a[0],a[1])},setUTC:function(){var a=jb(arguments);return pb(this,a[0],a[1],j)},setWeekday:function(a){M(a)||this.setDate(this.getDate()+a-this.getDay())},setUTCWeekday:function(a){M(a)||this.setDate(this.getUTCDate()+a-this.getDay())},setWeek:function(a){if(!M(a)){this.setMonth(0);this.setDate(a*7+1)}},setUTCWeek:function(a){if(!M(a)){this.setMonth(0);this.setUTCDate(a*7+1)}},getWeek:function(){return qb(this)},getUTCWeek:function(){return qb(this.toUTC())},
getUTCOffset:function(a){var b=this.ma?0:this.getTimezoneOffset(),c=a===j?":":"";if(!b&&a)return"Z";return Q(O(-b/60),2,j)+c+Q(b%60,2)},toUTC:function(){if(this.ma)return this;var a=this.clone().addMinutes(this.getTimezoneOffset());a.ma=j;return a},isUTC:function(){return this.ma||this.getTimezoneOffset()===0},advance:function(){var a=jb(arguments,j);return pb(this,a[0],a[1],m,1)},rewind:function(){var a=jb(arguments,j);return pb(this,a[0],a[1],m,-1)},isValid:function(){return!isNaN(this.getTime())},
isAfter:function(a,b){return this.getTime()>u.create(a).getTime()-(b||0)},isBefore:function(a,b){return this.getTime()<u.create(a).getTime()+(b||0)},isBetween:function(a,b,c){var d=this.getTime();a=u.create(a).getTime();var e=u.create(b).getTime();b=x.min(a,e);a=x.max(a,e);c=c||0;return b-c<d&&a+c>d},isLeapYear:function(){var a=this.getFullYear();return a%4===0&&a%100!==0||a%400===0},daysInMonth:function(){return 32-(new u(this.getFullYear(),this.getMonth(),32)).getDate()},format:function(a,b){return rb(this,
a,m,b)},relative:function(a,b){if(E(a)){b=a;a=k}return rb(this,a,j,b)},is:function(a,b){var c;if(this.isValid()){if(E(a)){a=a.trim().toLowerCase();switch(j){case a==="future":return this.getTime()>(new u).getTime();case a==="past":return this.getTime()<(new u).getTime();case a==="weekday":return this.getDay()>0&&this.getDay()<6;case a==="weekend":return this.getDay()===0||this.getDay()===6;case (c=W.weekdays.indexOf(a)%7)>-1:return this.getDay()===c;case (c=W.months.indexOf(a)%12)>-1:return this.getMonth()===
c}}return sb(this,a,b)}},reset:function(a){var b={};a=a||"hours";b[a]=a.match(/^days?/)?1:0;return this.set(b,j)},clone:function(){return new u(this.getTime())}});u.extend({iso:function(){return this.toISOString()},getWeekday:u.prototype.getDay,getUTCWeekday:u.prototype.getUTCDay});w.extend({duration:function(a){return gb(a).duration(this)}});W=u.setLocale("en");Va=Ya.concat().reverse();Ua=Ya.concat();Ua.splice(2,1);
J(u,j,m,Ya,function(a,b,c){var d=b.$,e=cb(d),g=b.da(),f,i;b.ka="add"+e+"s";f=function(h,l){return O((this.getTime()-u.create(h,l).getTime())/g)};i=function(h,l){return O((u.create(h,l).getTime()-this.getTime())/g)};a[d+"sAgo"]=i;a[d+"sUntil"]=i;a[d+"sSince"]=f;a[d+"sFromNow"]=f;a[b.ka]=function(h,l){var n={};n[d]=h;return this.advance(n,l)};wb(b,g);c<3&&["Last","This","Next"].forEach(function(h){a["is"+h+e]=function(){return this.is(h+" "+d)}});if(c<4){a["beginningOf"+e]=function(){var h={};switch(d){case "year":h.year=
...
W.addFormat("(\\d{1,2})[-.\\/]{full_month}(?:[-.\\/](\\d{2,4}))?",j,["date","month","year"],j);W.addFormat("{full_month}[-.](\\d{4,4})",m,["month","year"]);W.addFormat("\\/Date\\((\\d+(?:\\+\\d{4,4})?)\\)\\/",m,["timestamp"]);W.addFormat(eb(Ra,W),m,Qa);Wa=W.ha.slice(0,7).reverse();W.ha=W.ha.slice(7).concat(Wa);J(u,j,m,"short,long,full",function(a,b){a[b]=function(c){return rb(this,b,m,c)}});
"\u3007\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07".split("").forEach(function(a,b){if(b>9)b=x.pow(10,b-9);Sa[a]=b});"\uff10\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19".split("").forEach(function(a,b){Sa[a]=b});Ta=t("([\u671f\u9031\u5468])?([\u3007\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341\u767e\u5343\u4e07\uff10\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19]+)(?!\u6628)","g");
...
G(xb,j,m,{isValid:function(){return this.start<this.end},duration:function(){return this.isValid()?this.end.getTime()-this.start.getTime():NaN},contains:function(a){var b=this;return(a.start&&a.end?[a.start,a.end]:[a]).every(function(c){return c>=b.start&&c<=b.end})},every:function(a,b){var c=this.start.clone(),d=[],e=0,g;if(E(a)){c.advance(kb(a,0),j);g=kb(a)}else g={milliseconds:a};for(;c<=this.end;){d.push(c);b&&b(c,e);c=c.clone().advance(g,j);e++}return d},union:function(a){return new xb(this.start<
a.start?this.start:a.start,this.end>a.end?this.end:a.end)},intersect:function(a){return new xb(this.start>a.start?this.start:a.start,this.end<a.end?this.end:a.end)}});J(xb,j,m,"Millisecond,Second,Minute,Hour,Day,Week,Month,Year",function(a,b){a["each"+b]=function(c){return this.every(b,c)}});G(u,m,m,{range:function(a,b){return new xb(a,b)}});
function yb(a,b,c,d,e){if(!a.ga)a.ga=[];D(b)||(b=0);a.ga.push(setTimeout(function(){a.ga.splice(g,1);c.apply(d,e||[])},b));var g=a.ga.length}
G(Function,j,m,{lazy:function(a,b){function c(){if(!(g&&e.length>b-2)){e.push([this,arguments]);f()}}var d=this,e=[],g=m,f,i,h;a=a||1;b=b||Infinity;i=O(a,void 0,"ceil");h=O(i/a);f=function(){if(!(g||e.length==0)){for(var l=x.max(e.length-h,0);e.length>l;)Function.prototype.apply.apply(d,e.shift());yb(c,i,function(){g=m;f()});g=j}};return c},delay:function(a){var b=H(arguments).slice(1);yb(this,a,this,this,b);return this},throttle:function(a){return this.lazy(a,1)},debounce:function(a){var b=this;
...
G(w,m,m,{random:function(a,b){var c,d;if(arguments.length==1){b=a;a=0}c=x.min(a||0,M(b)?1:b);d=x.max(a||0,M(b)?1:b);return O(x.random()*(d-c)+c)}});
G(w,j,m,{log:function(a){return x.log(this)/(a?x.log(a):1)},abbr:function(a){return zb(this,a,"kmbt",0,4)},metric:function(a,b){return zb(this,a,"n\u03bcm kMGTPE",4,M(b)?1:b)},bytes:function(a,b){return zb(this,a,"kMGTPE",0,M(b)?4:b,j)+"B"},isInteger:function(){return this%1==0},isOdd:function(){return!this.isMultipleOf(2)},isEven:function(){return this.isMultipleOf(2)},isMultipleOf:function(a){return this%a===0},format:function(a,b,c){var d,e,g=/(\d+)(\d{3})/;if(v(b).match(/\d/))throw new TypeError("Thousands separator cannot contain numbers.");
d=D(a)?O(this,a||0).toFixed(x.max(a,0)):this.toString();b=b||",";c=c||".";e=d.split(".");d=e[0];for(e=e[1]||"";d.match(g);)d=d.replace(g,"$1"+b+"$2");if(e.length>0)d+=c+oa((a||0)-e.length,"0")+e;return d},hex:function(a){return this.pad(a||1,m,16)},upto:function(a,b,c){return N(this,a,b,c||1)},downto:function(a,b,c){return N(this,a,b,-(c||1))},times:function(a){if(a)for(var b=0;b<this;b++)a.call(this,b);return this.toNumber()},chr:function(){return v.fromCharCode(this)},pad:function(a,b,c){return Q(this,
a,b,c)},ordinalize:function(){var a=this.abs();a=parseInt(a.toString().slice(-2));return this+pa(a)},toNumber:function(){return parseFloat(this,10)}});J(w,j,m,"round,floor,ceil",function(a,b){a[b]=function(c){return O(this,c,b)}});J(w,j,m,"abs,pow,sin,asin,cos,acos,tan,atan,exp,pow,sqrt",function(a,b){a[b]=function(c,d){return x[b](this,c,d)}});
...
this;H(arguments.length>0?arguments:["\\S+"],function(b){b=t("<("+b+")[^<>]*(?:\\/>|>.*?<\\/\\1>)","gi");a=a.replace(b,"")});return a},truncate:function(a,b,c,d){var e="",g="",f=this.toString(),i="["+qa()+"]+",h="[^"+qa()+"]*",l=t(i+h+"$");d=M(d)?"...":v(d);if(f.length<=a)return f;switch(c){case "left":a=f.length-a;e=d;f=f.slice(a);l=t("^"+h+i);break;case "middle":a=P(a/2);g=d+f.slice(f.length-a).trimLeft();f=f.slice(0,a);break;default:a=a;g=d;f=f.slice(0,a)}if(b===m&&this.slice(a,a+1).match(/\S/))f=
f.remove(l);return e+f+g},pad:function(a,b){return oa(b,a)+this+oa(b,a)},padLeft:function(a,b){return oa(b,a)+this},padRight:function(a,b){return this+oa(b,a)},first:function(a){if(M(a))a=1;return this.substr(0,a)},last:function(a){if(M(a))a=1;return this.substr(this.length-a<0?0:this.length-a)},repeat:function(a){var b="",c=0;if(D(a)&&a>0)for(;c<a;){b+=this;c++}return b},toNumber:function(a){var b=this.replace(/,/g,"");return b.match(/\./)?parseFloat(b):parseInt(b,a||10)},capitalize:function(a){var b;
return this.toLowerCase().replace(a?/[\s\S]/g:/^\S/,function(c){var d=c.toUpperCase(),e;e=b?c:d;b=d!==c;return e})},assign:function(){var a={};H(arguments,function(b,c){if(la(b))na(a,b);else a[c+1]=b});return this.replace(/\{([^{]+?)\}/g,function(b,c){return ma(a,c)?a[c]:b})}});
G(v,j,function(a){return F(a)},{split:function(a,b){var c=[],d=0,e=ra(a,"g");a=new t(a.source,e);var g,f,i;t.oa||(g=t("^"+a.source+"$(?!\\s)",e));if(M(b)||b<0)b=Infinity;else{b=P(b);if(!b)return[]}for(;f=a.exec(this);){e=f.index+f[0].length;if(e>d){c.push(this.slice(d,f.index));!t.oa&&f.length>1&&f[0].replace(g,function(){for(var h=1;h<arguments.length-2;h++)if(M(arguments[h]))f[h]=void 0});f.length>1&&f.index<this.length&&s.prototype.push.apply(c,f.slice(1));i=f[0].length;d=e;if(c.length>=b)break}a.lastIndex===
f.index&&a.lastIndex++}if(d===this.length){if(i||!a.test(""))c.push("")}else c.push(this.slice(d));return c.length>b?c.slice(0,b):c}});G(v,j,m,{insert:v.prototype.add});
(function(a){if(this.btoa){Lb=this.btoa;Mb=this.atob}else{var b=/[^A-Za-z0-9\+\/\=]/g;Lb=function(c){var d="",e,g,f,i,h,l,n=0;do{e=c.charCodeAt(n++);g=c.charCodeAt(n++);f=c.charCodeAt(n++);i=e>>2;e=(e&3)<<4|g>>4;h=(g&15)<<2|f>>6;l=f&63;if(isNaN(g))h=l=64;else if(isNaN(f))l=64;d=d+a.charAt(i)+a.charAt(e)+a.charAt(h)+a.charAt(l)}while(n<c.length);return d};Mb=function(c){var d="",e,g,f,i,h,l=0;if(c.match(b))throw Error("String contains invalid base64 characters");c=c.replace(/[^A-Za-z0-9\+\/\=]/g,"");
do{e=a.indexOf(c.charAt(l++));g=a.indexOf(c.charAt(l++));i=a.indexOf(c.charAt(l++));h=a.indexOf(c.charAt(l++));e=e<<2|g>>4;g=(g&15)<<4|i>>2;f=(i&3)<<6|h;d+=v.fromCharCode(e);if(i!=64)d+=v.fromCharCode(g);if(h!=64)d+=v.fromCharCode(f)}while(l<c.length);return d}}})("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=");
(function(){var a;Db.forEach(function(b){N(b.start,b.end,function(c){Y(b.type,v.fromCharCode(c),v.fromCharCode(c+b.shift))})});"\u30a2\u30a4\u30a6\u30a8\u30aa\u30a1\u30a3\u30a5\u30a7\u30a9\u30ab\u30ad\u30af\u30b1\u30b3\u30b5\u30b7\u30b9\u30bb\u30bd\u30bf\u30c1\u30c4\u30c3\u30c6\u30c8\u30ca\u30cb\u30cc\u30cd\u30ce\u30cf\u30d2\u30d5\u30d8\u30db\u30de\u30df\u30e0\u30e1\u30e2\u30e4\u30e3\u30e6\u30e5\u30e8\u30e7\u30e9\u30ea\u30eb\u30ec\u30ed\u30ef\u30f2\u30f3\u30fc\u30fb".each(function(b,c){a="\uff71\uff72\uff73\uff74\uff75\uff67\uff68\uff69\uff6a\uff6b\uff76\uff77\uff78\uff79\uff7a\uff7b\uff7c\uff7d\uff7e\uff7f\uff80\uff81\uff82\uff6f\uff83\uff84\uff85\uff86\uff87\uff88\uff89\uff8a\uff8b\uff8c\uff8d\uff8e\uff8f\uff90\uff91\uff92\uff93\uff94\uff6c\uff95\uff6d\uff96\uff6e\uff97\uff98\uff99\uff9a\uff9b\uff9c\uff66\uff9d\uff70\uff65".charAt(c);
Y("k",a,b);b.match(Ib)&&Y("k",a+"\uff9e",b.shift(1));b.match(Jb)&&Y("k",a+"\uff9f",b.shift(2))});"\u3002\u3001\u300c\u300d\uffe5\uffe0\uffe1".each(function(b,c){Y("p","\uff61\uff64\uff62\uff63\u00a5\u00a2\u00a3".charAt(c),b)});Y("k","\uff73\uff9e","\u30f4");Y("k","\uff66\uff9e","\u30fa");Y("s"," ","\u3000")})();
...
{ca:["Thai"],source:"\u0e00-\u0e7f"}].forEach(function(a){var b=t("^["+a.source+"\\s]+$"),c=t("["+a.source+"]");a.ca.forEach(function(d){ia(v.prototype,"is"+d,function(){return b.test(this.trim())});ia(v.prototype,"has"+d,function(){return c.test(this)})})});
var Nb=[],Ob=[],Z=[],Pb=[],Qb={},Rb={},Sb="",Ub,$;function Vb(a,b){var c=a.indexOf(b);c>-1&&a.splice(c,1)}function Wb(a,b,c){E(b)&&Vb(Z,b);Vb(Z,c);a.unshift({la:b,ua:c})}
function Xb(a,b){return a==b||a=="all"||!a}function Yb(a){return Z.some(function(b){return(new t("\\b"+b+"$","i")).test(a)})}function Zb(a,b){a=E(a)?a.toString():"";return a.isBlank()||Yb(a)?a:$b(a,b?Nb:Ob)}function $b(a,b){I(b,function(c,d){if(a.match(d.la)){a=a.replace(d.la,d.ua);return m}});return a}function ac(a){return a.replace(/^\W*[a-z]/,function(b){return b.toUpperCase()})}
$={acronym:function(a){Qb[a.toLowerCase()]=a;a=r.keys(Qb).map(function(b){return Qb[b]});$.acronymRegExp=t(a.join("|"),"g")},plural:function(a,b){Wb(Nb,a,b)},singular:function(a,b){Wb(Ob,a,b)},irregular:function(a,b){var c=a.first(),d=a.from(1),e=b.first(),g=b.from(1),f=e.toUpperCase(),i=e.toLowerCase(),h=c.toUpperCase(),l=c.toLowerCase();Vb(Z,a);Vb(Z,b);if(h==f){$.plural(new t("({1}){2}$".assign(c,d),"i"),"$1"+g);$.plural(new t("({1}){2}$".assign(e,g),"i"),"$1"+g);$.singular(new t("({1}){2}$".assign(e,
g),"i"),"$1"+d)}else{$.plural(new t("{1}{2}$".assign(h,d)),f+g);$.plural(new t("{1}{2}$".assign(l,d)),i+g);$.plural(new t("{1}{2}$".assign(f,g)),f+g);$.plural(new t("{1}{2}$".assign(i,g)),i+g);$.singular(new t("{1}{2}$".assign(f,g)),h+d);$.singular(new t("{1}{2}$".assign(i,g)),l+d)}},uncountable:function(a){var b=s.isArray(a)?a:H(arguments);Z=Z.concat(b)},human:function(a,b){Pb.unshift({la:a,ua:b})},clear:function(a){if(Xb(a,"singulars"))Ob=[];if(Xb(a,"plurals"))Nb=[];if(Xb(a,"uncountables"))Z=[];
if(Xb(a,"humans"))Pb=[];if(Xb(a,"acronyms"))Qb={}}};Ub=["and","or","nor","a","an","the","so","but","to","of","at","by","from","into","on","onto","off","out","in","over","with","for"];$.plural(/$/,"s");$.plural(/s$/gi,"s");$.plural(/(ax|test)is$/gi,"$1es");$.plural(/(octop|vir|fung|foc|radi|alumn)(i|us)$/gi,"$1i");$.plural(/(census|alias|status)$/gi,"$1es");$.plural(/(bu)s$/gi,"$1ses");$.plural(/(buffal|tomat)o$/gi,"$1oes");$.plural(/([ti])um$/gi,"$1a");$.plural(/([ti])a$/gi,"$1a");
$.plural(/sis$/gi,"ses");$.plural(/f+e?$/gi,"ves");$.plural(/(cuff|roof)$/gi,"$1s");$.plural(/([ht]ive)$/gi,"$1s");$.plural(/([^aeiouy]o)$/gi,"$1es");$.plural(/([^aeiouy]|qu)y$/gi,"$1ies");$.plural(/(x|ch|ss|sh)$/gi,"$1es");$.plural(/(matr|vert|ind)(?:ix|ex)$/gi,"$1ices");$.plural(/([ml])ouse$/gi,"$1ice");$.plural(/([ml])ice$/gi,"$1ice");$.plural(/^(ox)$/gi,"$1en");$.plural(/^(oxen)$/gi,"$1");$.plural(/(quiz)$/gi,"$1zes");$.plural(/(phot|cant|hom|zer|pian|portic|pr|quart|kimon)o$/gi,"$1os");
...
G(v,j,m,{pluralize:function(){return Zb(this,j)},singularize:function(){return Zb(this,m)},humanize:function(){var a=$b(this,Pb);a=a.replace(/_id$/g,"");a=a.replace(/(_)?([a-z\d]*)/gi,function(b,c,d){return(c?" ":"")+(Qb[d]||d.toLowerCase())});return ac(a)},titleize:function(){var a=/[.:;!]$/,b,c,d;return this.spacify().humanize().words(function(e,g,f){b=a.test(e);d=g==0||g==f.length-1||b||c;c=b;return d||Ub.indexOf(e)===-1?ac(e):e}).join(" ")},namespace:function(){var a=aa;I(this.split("."),function(b,
c){return!!(a=a[c])});return a},parameterize:function(a){if(a===undefined)a="-";var b=this.normalize();b=b.replace(/[^a-z0-9\-_]+/gi,a);if(a)b=b.replace(new t("^{sep}+|{sep}+$|({sep}){sep}+".assign({sep:R(a)}),"g"),"$1");return b.toLowerCase()},normalize:function(){return this.replace(Sb,function(a){return Rb[a]})}});
I({A:"A\u24b6\uff21\u00c0\u00c1\u00c2\u1ea6\u1ea4\u1eaa\u1ea8\u00c3\u0100\u0102\u1eb0\u1eae\u1eb4\u1eb2\u0226\u01e0\u00c4\u01de\u1ea2\u00c5\u01fa\u01cd\u0200\u0202\u1ea0\u1eac\u1eb6\u1e00\u0104\u023a\u2c6f",B:"B\u24b7\uff22\u1e02\u1e04\u1e06\u0243\u0182\u0181",C:"C\u24b8\uff23\u0106\u0108\u010a\u010c\u00c7\u1e08\u0187\u023b\ua73e",D:"D\u24b9\uff24\u1e0a\u010e\u1e0c\u1e10\u1e12\u1e0e\u0110\u018b\u018a\u0189\ua779",E:"E\u24ba\uff25\u00c8\u00c9\u00ca\u1ec0\u1ebe\u1ec4\u1ec2\u1ebc\u0112\u1e14\u1e16\u0114\u0116\u00cb\u1eba\u011a\u0204\u0206\u1eb8\u1ec6\u0228\u1e1c\u0118\u1e18\u1e1a\u0190\u018e",
...
OO:"\ua74e",OU:"\u0222",TZ:"\ua728",VY:"\ua760",aa:"\ua733",ae:"\u00e6\u01fd\u01e3",ao:"\ua735",au:"\ua737",av:"\ua739\ua73b",ay:"\ua73d",dz:"\u01f3\u01c6",hv:"\u0195",lj:"\u01c9",nj:"\u01cc",oi:"\u01a3",ou:"\u0223",oo:"\ua74f",ss:"\u00df",tz:"\ua729",vy:"\ua761"},function(a,b){b.split("").forEach(function(c){Rb[c]=a});Sb+=b});Sb=t("["+Sb+"]","g");v.Inflector=$;v.Inflector.acronyms=Qb;})();