...
else a[b]=c},s=function(a){if(typeof a[0]==="object")return a;else if(a.length==1&&Object.isNumber(a[0]))return[a[0]];for(var b={},c=Array.prototype.slice.call(arguments,1),d=0;d<a.length;d++)b[c[d]]=a[d];return[b]},y=function(a,b){if(typeof a=="object"&&typeof b=="object"){var c=false,d;for(d in a)if(a.hasOwnProperty(d)){if(!y(a[d],b[d]))return false;c=true}if(!c)for(d in b)if(b.hasOwnProperty(d))return false;return true}else return a===b},n=function(a,b,c,d){return Object.isRegExp(b)?b.test(a):
Object.isFunction(b)?b.apply(c,[a].concat(d)):typeof b==="object"?y(b,a):b!==undefined?b===a:!!a},t=function(a,b,c,d){return Object.isFunction(b)?b.apply(c,[a].concat(d)):b===undefined?a:typeof a[b]=="function"?a[b].call(a):a[b]},z=function(a,b,c){var d=b==="max";b=b==="min";var e=d?-Infinity:Infinity,f=[],g;for(g in a)if(a.hasOwnProperty(g)){var h=a[g],i=t(h,c);if(!(i===undefined||i===null))if(i===e)f.push(h);else if(d&&i>e||b&&i<e){f=[h];e=i}}return f},L=function(a,b,c){var d=b[b.length-1]!==false,
e=[],f,g;for(g=0;g<b.length;g++){f=b[g];if(f===true||f===false)break;if(d){f%=a.length;if(f<0)f=a.length+f}if(f>=0&&f<a.length)e.push(c?a.charAt(f):a[f])}return e.length==0?c?"":null:e.length==1?e[0]:e},I=function(a,b){return Object.prototype.toString.call(a)==="[object "+b+"]"},A=function(a){var b=Object.isArray(a)?[]:Object.extended({});q(a,function(c,d){b[c]=Object.isObject(d)||Object.isArray(d)?A(d):d});return b},u=function(a){var b=this;q(a,function(c,d){b[c]=d})};u.prototype.constructor=Object;
var M=["Array","Boolean","Date","Function","Number","String","RegExp"],N=["keys","values","each","merge","isEmpty","equals"],q=function(a,b){var c=0,d;for(d in a)if(a.hasOwnProperty(d)){b.call(a,d,a[d],c);c++}};k(Object,false,{extended:function(a){return new u(a)}});k(Object,false,{isObject:function(a){return a===null||a===undefined||arguments.length===0?false:I(a,"Object")&&a.constructor===Object},each:function(a,b){q(a,function(c,d){b&&b.call(a,c,d,a)});return a},merge:function(){for(var a=arguments[0],
b=1;b<arguments.length;b++){var c=arguments[b],d;for(d in c)if(c.hasOwnProperty(d))a[d]=c[d]}return a},isEmpty:function(a){return y(a,{})},equals:function(a,b){return y(a,b)}});x(Object,false,function(){return arguments.length==1},{keys:function(a,b){var c=[];q(a,function(d){c.push(d);b&&b.call(a,d)});return c},values:function(a,b){var c=[];q(a,function(d,e){c.push(e);b&&b.call(a,e)});return c}});RegExp.NPCGSupport=/()??/.exec("")[1]===undefined;k(RegExp,false,{escape:function(a){return a.replace(/([/'*+?|()\[\]{}.^$])/g,
...
"st";break;case 2:a="nd";break;case 3:a="rd";break;default:a="th"}return this.toString()+a},pad:function(a,b){var c=this.toNumber()===0?"":this.toString().replace(/^-/,"");c=c.padLeft(a-c.length,"0");if(b||this<0)c=(this<0?"-":"+")+c;return c},format:function(a,b){a=a||",";b=b||".";var c=this.toString().split("."),d=c[0];c=c.length>1?b+c[1]:"";for(var e=/(\d+)(\d{3})/;e.test(d);)d=d.replace(e,"$1"+a+"$2");return d+c},hex:function(){return this.toString(16)}});var o,v,B,C,$=[{base:"A",reg:/[A\u24b6\uff21\u00c0\u00c1\u00c2\u1ea6\u1ea4\u1eaa\u1ea8\u00c3\u0100\u0102\u1eb0\u1eae\u1eb4\u1eb2\u0226\u01e0\u00c4\u01de\u1ea2\u00c5\u01fa\u01cd\u0200\u0202\u1ea0\u1eac\u1eb6\u1e00\u0104\u023a\u2c6f]/g},
...
!a.test(""))c.push("")}else c.push(this.slice(d));return c.length>b?c.slice(0,b):c}});k(String,true,{insert:String.prototype.add});x(Array,true,true,{forEach:function(a,b){for(var c=0,d=this.length;c<d;c++)a.call(b,this[c],c,this)},reduce:function(a,b){for(var c=b===undefined?this[0]:b,d=b?0:1,e=this.length;d<e;d++)c=a.call(null,c,this[d],d,this);return c},reduceRight:function(a,b){for(var c=b===undefined?this[this.length-1]:b,d=b?this.length-1:this.length-2;d>=0;d--)c=a.call(null,c,this[d],d,this);
return c}});k(Array,true,{indexOf:function(a,b){if(b<0)b=this.length+b;else if(b===undefined)b=0;if(b>=this.length)return-1;for(var c=b,d=this.length;c<d;c++)if(n(this[c],a,this,[c,this]))return c;return-1},lastIndexOf:function(a,b){if(b<0)b=this.length+b;else if(b===undefined||b>this.length)b=this.length-1;for(var c=b;c>=0;c--)if(n(this[c],a,this,[c,this]))return c;return-1}});x(Array,true,function(a){return Object.isFunction(a)},{every:function(a,b){for(var c=0,d=this.length;c<d;c++)if(!n(this[c],
a,b,[c,this]))return false;return true},some:function(a,b){for(var c=0,d=this.length;c<d;c++)if(n(this[c],a,b,[c,this]))return true;return false},filter:function(a,b){for(var c=[],d=0,e=this.length;d<e;d++)n(this[d],a,b,[d,this])&&c.push(this[d]);return c},map:function(a,b){for(var c=[],d=0,e=this.length;d<e;d++)c.push(t(this[d],a,b,[d,this]));return c}});k(Array,true,{find:function(a,b,c){a=this.findAll(a,b,c);return a.length>0?a[0]:undefined},findAll:function(a,b,c){var d=[],e=this;b=b||0;this.eachFromIndex(b,
function(f,g){n(f,a,e,[g,e])&&d.push(f)},c);return d},eachFromIndex:function(a,b,c){c=c?this.length:this.length-a;for(var d,e=0;e<c;e++){d=(a+e)%this.length;b.call(this,this[d],d)}},count:function(a){if(a===undefined)return this.length;return this.findAll(a).length},none:function(a){return!this.any(a)},remove:function(a){for(var b=0;a&&b<this.length;)if(n(this[b],a,this,[b,this]))this.splice(b,1);else b++;return this},removeAtIndex:function(a,b){if(a===undefined)return this;if(b===undefined)b=a;for(var c=
0;c<=b-a;c++)this.splice(a,1);return this},add:function(a,b){if(!Object.isNumber(b)||isNaN(b))b=this.length;Array.prototype.splice.apply(this,[b,0].concat(a));return this},include:function(a,b){return this.clone().add(a,b)},exclude:function(a){return this.clone().remove(a)},clone:function(){return this.concat()},unique:function(){var a=[];this.each(function(b){a.find(b)===undefined&&a.push(b)});return a},union:function(a){return this.concat(a).unique()},intersect:function(a){var b=[];Object.isArray(a)||
(a=[a]);this.each(function(c){a.find(c)!==undefined&&b.push(c)});return b.unique()},subtract:function(a){var b=[];Object.isArray(a)||(a=[a]);this.each(function(c){a.find(c)===undefined&&b.push(c)});return b},at:function(){return L(this,arguments,false)},first:function(a){if(a===undefined)return this[0];if(a<0)a=0;return this.slice(0,a)},last:function(a){if(a===undefined)return this[this.length-1];return this.slice(this.length-a<0?0:this.length-a)},from:function(a){return this.slice(a)},to:function(a){if(a===
undefined)a=this.length;return this.slice(0,a)},min:function(a){return z(this,"min",a).unique()},max:function(a){return z(this,"max",a).unique()},least:function(a){a=z(this.groupBy(a),"min","length").flatten();return a.length===this.length?[]:a.unique()},most:function(a){a=z(this.groupBy(a),"max","length").flatten();return a.length===this.length?[]:a.unique()},sum:function(a){a=a?this.map(a):this;return a.length>0?a.reduce(function(b,c){return b+c}):0},average:function(a){a=a?this.map(a):this;return a.length>
0?a.sum()/a.length:0},groupBy:function(a){var b={};this.each(function(c){var d=t(c,a);b[d]||(b[d]=[]);b[d].push(c)});return b},inGroups:function(a,b){var c=arguments.length>1,d=this,e=[],f=Math.ceil(this.length/a);(0).upto(a-1,function(g){g=g*f;var h=d.slice(g,g+f);c&&h.length<f&&(f-h.length).times(function(){h=h.add(b)});e.push(h)});return e},inGroupsOf:function(a,b){if(this.length===0||a===0)return this;if(a===undefined)a=1;if(b===undefined)b=null;var c=[],d=null;this.each(function(e,f){if(f%a===
0){d&&c.push(d);d=[]}if(e===undefined)e=b;d.push(e)});if(!this.length.isMultipleOf(a)){(a-this.length%a).times(function(){d.push(b)});this.length+=a-this.length%a}d.length>0&&c.push(d);return c},split:function(a){var b=[],c=[];this.forEach(function(d,e,f){var g=n(d,a,f,[e,f]);g||c.push(d);if(c.length>0&&(g||e==f.length-1)){b.push(c);c=[]}});return b},compact:function(){var a=[];this.each(function(b){if(Object.isArray(b))a.push(b.compact());else b!==undefined&&b!==null&&!isNaN(b)&&a.push(b)});return a},
isEmpty:function(){return this.compact().length==0},flatten:function(){var a=[];this.each(function(b){if(Object.isArray(b))a=a.concat(b.flatten());else a.push(b)});return a},sortBy:function(a,b){this.sort(function(c,d){var e=t(c,a),f=t(d,a),g=typeof e=="number";return g&&b?f-e:g&&!b?e-f:e===f?0:b?e<f?1:-1:e<f?-1:1});return this},randomize:function(){for(var a=this.concat(),b,c,d=a.length;d;b=parseInt(Math.random()*d),c=a[--d],a[d]=a[b],a[b]=c);return a}});k(Array,true,{collect:Array.prototype.map,
...
g}if(h.millisecond)h.millisecond=(parseFloat(h.millisecond,10)*1E3).round();r.each(function(w){w=w.unit;if(h[w]!==undefined)d[w]=h[w].toNumber()});if(h.meridian)if(h.meridian==="pm"&&h.hour<12)d.hour+=12;if(h.utc||h.offset_hours||h.offset_minutes){e=true;g=0;if(h.offset_hours)g+=h.offset_hours.toNumber()*60;if(h.offset_minutes)g+=h.offset_minutes.toNumber();if(h.offset_sign&&h.offset_sign==="-")g*=-1;d.minute-=g}if(h.modifier_unit&&h.modifier_sign){g=h.modifier_amount||1;i=h.modifier_unit;var m;g=
...
1);return this.timer=setTimeout(function(){return b.apply(b,c)},a)},defer:function(){this.delay.apply(this,[0].concat(Array.prototype.slice.call(arguments)));return this},cancel:function(){return clearTimeout(this.timer)}});(function(){M.slice(1).each(function(a){j(Object,"is"+a,function(b){return I(b,a)})});j(Object,"isArray",Array.isArray||function(a){return I(a,"Array")});N.each(function(a){j(u.prototype,a,function(){return Object[a].apply(null,[this].concat(Array.prototype.slice.call(arguments)))})});
j(Object,"clone",A);j(u.prototype,"clone",function(){return A(this)});j(Object,"enableSugar",function(){M.each(function(a){j(Object.prototype,"is"+a,function(){return Object["is"+a](this)})});N.each(function(a){j(Object.prototype,a,u.prototype[a])});j(Object.prototype,"clone",function(){return A(this)})})})();(function(){B={};C={};for(var a=0;a<Q.length;a++){var b=Q[a];B[b.kata]=b;C[b.hira]=b}})();(function(){o={};v={};for(var a=0;a<P.length;a++){var b=P[a];o[b.half]=b;v[b.full]=b}})();(function(){aa.each(function(a){var b=
