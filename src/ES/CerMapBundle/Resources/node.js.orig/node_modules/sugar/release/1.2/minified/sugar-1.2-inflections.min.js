...
aa:/[\ua733]/g,ae:/[\u00e6\u01fd\u01e3]/g,ao:/[\ua735]/g,au:/[\ua737]/g,av:/[\ua739\ua73b]/g,ay:/[\ua73d]/g,dz:/[\u01f3\u01c6]/g,hv:/[\u0195]/g,lj:/[\u01c9]/g,nj:/[\u01cc]/g,oi:/[\u01a3]/g,ou:/[\u0223]/g,oo:/[\ua74f]/g,ss:/[\u00df]/g,tz:/[\ua729]/g,vy:/[\ua761]/};r.plural(/$/,"s");r.plural(/s$/gi,"s");r.plural(/(ax|test)is$/gi,"$1es");r.plural(/(octop|vir)us$/gi,"$1i");r.plural(/(octop|vir)i$/gi,"$1i");r.plural(/(alias|status)$/gi,"$1es");r.plural(/(bu)s$/gi,"$1ses");
r.plural(/(buffal|tomat)o$/gi,"$1oes");r.plural(/([ti])um$/gi,"$1a");r.plural(/([ti])a$/gi,"$1a");r.plural(/sis$/gi,"ses");r.plural(/(?:([^f])fe|([lr])f)$/gi,"$1$2ves");r.plural(/(hive)$/gi,"$1s");r.plural(/([^aeiouy]|qu)y$/gi,"$1ies");r.plural(/(x|ch|ss|sh)$/gi,"$1es");r.plural(/(matr|vert|ind)(?:ix|ex)$/gi,"$1ices");r.plural(/([ml])ouse$/gi,"$1ice");r.plural(/([ml])ice$/gi,"$1ice");r.plural(/^(ox)$/gi,"$1en");r.plural(/^(oxen)$/gi,"$1");r.plural(/(quiz)$/gi,"$1zes");r.singular(/s$/gi,"");
r.singular(/(n)ews$/gi,"$1ews");r.singular(/([ti])a$/gi,"$1um");r.singular(/((a)naly|(b)a|(d)iagno|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$/gi,"$1$2sis");r.singular(/(^analy)ses$/gi,"$1sis");r.singular(/([^f])ves$/gi,"$1fe");r.singular(/(hive)s$/gi,"$1");r.singular(/(tive)s$/gi,"$1");r.singular(/([lr])ves$/gi,"$1f");r.singular(/([^aeiouy]|qu)ies$/gi,"$1y");r.singular(/(s)eries$/gi,"$1eries");r.singular(/(m)ovies$/gi,"$1ovie");r.singular(/(x|ch|ss|sh)es$/gi,"$1");r.singular(/([ml])ice$/gi,"$1ouse");
r.singular(/(bus)es$/gi,"$1");r.singular(/(o)es$/gi,"$1");r.singular(/(shoe)s$/gi,"$1");r.singular(/(cris|ax|test)es$/gi,"$1is");r.singular(/(octop|vir)i$/gi,"$1us");r.singular(/(alias|status)es$/gi,"$1");r.singular(/^(ox)en/gi,"$1");r.singular(/(vert|ind)ices$/gi,"$1ex");r.singular(/(matr)ices$/gi,"$1ix");r.singular(/(quiz)zes$/gi,"$1");r.singular(/(database)s$/gi,"$1");r.irregular("person","people");r.irregular("man","men");r.irregular("child","children");r.irregular("sex","sexes");
r.irregular("move","moves");r.irregular("cow","kine");r.irregular("zombie","zombies");r.uncountable("equipment,information,rice,money,species,series,fish,sheep,jeans".split(","));
