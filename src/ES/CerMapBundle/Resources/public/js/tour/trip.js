...
(function(window, $) {
    ...
    Trip.prototype = {
        ...
        setTripBlock : function( o ) {
            ...
            $tripArrow.removeClass('e s w n x');
                ...
                var html = [
                    '<div class="trip-block">',
                        ...
                        '<div class="trip-progress-wrapper">',
                            ...
                            '<a href="#" class="left rounded-3 text-shadow text-white shadow gradient-deepdark trip-prev"></a>',
                            '<span href="#" class="absolute note" style="width: 120px; left:50%; margin-left: -60px; bottom: 10px;"><span class="text-lightengray">esc</span> per chiudere<br><span class="text-lightengray">←</span> o <span class="text-lightengray">→</span> per scorrere</span>',
                            '<a href="#" class="right rounded-3 text-shadow text-white shadow gradient-deepdark  trip-next"></a>',
                        '</div>',
